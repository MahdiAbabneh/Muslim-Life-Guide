...
Widget emptyCard(String namJuz,numJuz) {
  return Container(
    width: 25,
    height: 25,
...
Widget emptyCardAdkar(String adkar) {
  return Container(
    width: 25,
    height: 25,
    margin: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 8.0),
...
List<String> timer_Pray =["00:00","00:00","00:00","00:00","00:00","00:00"];

List<String> countries =
['AE', 'BH', 'DJ', 'DZ', 'EG', 'PS', 'IQ', 'JO', 'KM', 'KW', 'LB', 'LY', 'MA', 'MR', 'OM', 'QA', 'SA', 'SD', 'SO', 'SY', 'TN', 'YE'];
...
final Map<String, List<Map<String, String>>>  adkarList ={
  "أذكار الصباح": [
    {
